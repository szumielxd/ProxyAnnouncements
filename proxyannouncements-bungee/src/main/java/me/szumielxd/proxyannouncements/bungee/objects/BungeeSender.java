...
public class BungeeSender implements CommonSender {
	...
	protected final @NotNull ProxyAnnouncementsBungee plugin;
	private final @NotNull CommandSender sender;
	
	
	public BungeeSender(@NotNull ProxyAnnouncementsBungee plugin, @NotNull CommandSender sender) {
	...
	public static @NotNull BungeeSender wrap(@NotNull ProxyAnnouncementsBungee plugin, @NotNull CommandSender sender) {
