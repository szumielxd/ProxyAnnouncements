...
public class VelocitySender implements CommonSender {
	...
	protected final @NotNull ProxyAnnouncementsVelocity plugin;
	private final @NotNull CommandSource sender;
	
	
	public VelocitySender(@NotNull ProxyAnnouncementsVelocity plugin, @NotNull CommandSource sender) {
	...
	public static @NotNull VelocitySender wrap(@NotNull ProxyAnnouncementsVelocity plugin, @NotNull CommandSource sender) {
